...
<div id="<?= $participant->id;?>" class="modal fade" tabindex="-1" >
	...
	<div class="modal-dialog" style="max-width: 300px; margin-top:180px; ">
		<div class="modal-content">
			...
			<div class="modal-body">
				<center>
					<h4 class="smaller lighter blue no-margin" style="color: #f03a00;"> <i class="glyphicon glyphicon-trash"></i> <b> Supprimer participant ?</b></h4>
	...
	<?php
		...
		if (isset($_POST['supprimer'])) {
			Query::supprimer('etudiant',$_POST['id']);
