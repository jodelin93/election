    	...
    	<?php include('../include-admin/menu.php'); ?>
          ...
          <div class="content-box-large">
            <div class="panel-heading">
              <h4 style="font-weight: bold;"> <i class="glyphicon glyphicon-plus"></i> Ajouter un (e) candidat (e)</h4><hr/>
              <a href="./">
                 <button class="btn btn-info"> <i class="glyphicon glyphicon-list"></i> <b>Liste des candidats</b></button>
               </a><hr/>
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">Nom du candidat</label>
                <div class="col-sm-10">
